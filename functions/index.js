  ...
  cors(request, response, () => {
    ...
    if (total) {
      if (category) {
        ...
        mailOptions = {mailOptions, to: "ylliineziri@gmail.com", subject: "Estimate received!", html: `
...
`};
        ...
        mailOptions = {mailOptions, to: "ylliineziri@gmail.com", subject: "Estimate received!", html: `
            ...
            <p style="font-size: 16px">Total: ${total}</p>
            <p style="font-size: 16px">Service: ${service}</p>
            <p style="font-size: 16px">Platforms: ${category}</p>
...
`};
      ...
      mailOptions = {mailOptions, to: email, subject: "We have received your message!", html: `
  ...
  <body align="center" style="margin:0; padding:0; background:#e5e5e5;">
    ...
    >
      <tr>
       ...
       Tahoma; font-size:34.28px; font-weight:normal; 
        ...
        color:#fff; text-align:center;"
                                        >
// eslint-disable-next-line max-len
Thanks for placing your esimate request! 
...
background-position:top right"
     ...
     style="width:18px; max-width:18px; display:block"
                                      ...
                                      <td
                                        align="left"
    style="padding:0px 0px 7px 5px;font-family: 'Roboto',
    Tahoma, Segoe, sans-serif; font-size:13.70px; font-weight:normal; 
    line-height:14px; color:#ffffff; text-align:left;"
                                        class="font11"
                                      >
                                        (555) 555-5555
                                      </td>
...
style="width:18px; max-width:18px; display:block"
                                      ...
                                      <td
                                        align="left"
style="padding:0px 0px 0px 5px;font-family: 'Roboto', 
Tahoma, Segoe, sans-serif; font-size:13.70px; font-weight:normal;
line-height:14px; color:#ffffff; text-align:left;"
                                        class="font11"
                                      >
     ...
     style="width:30px; max-width:30px; display:block"
      ...
      // eslint-disable-next-line max-len
      mailOptions = {mailOptions, to: "ylliineziri@gmail.com", subject: "Message received!", html: `
            <p style="font-size: 16px">From: ${name}</p>
            <p style="font-size: 16px">Email: ${email}</p>
            <p style="font-size: 16px">Phone Number: ${phone}</p>
            <p style="font-size: 16px">Message: ${message}</p>
