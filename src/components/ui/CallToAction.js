...
export default function CallToAction(props) {
    ...
    return (
        <Grid container style={{height: "60em"}} alignItems="center" justify={matchesSM ? "center" : "space-between"}
            ...
            <Grid item style={{marginLeft: matchesSM ? 0 : "5em", textAlign: matchesSM ? "center" : "inherit"}}>
                <Grid container direction="column">
                    <Grid item>
                        ...
                        <Typography className={classes.sub2} style={{fontSize: "1.5rem"}}>Take advantage of the 21st
                            Century.</Typography>
